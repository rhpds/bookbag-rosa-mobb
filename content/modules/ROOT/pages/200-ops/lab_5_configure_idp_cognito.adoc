...
----
ROSA_USER_PASSWORD=$(htpasswd -nbB 10 "" | cut -d: -f2)
aws cognito-idp admin-create-user \
  --user-pool-id $AWS_USER_POOL_ID \
  --username admin \
  --temporary-password $ROSA_USER_PASSWORD \
...
//https://oauth-openshift.apps.rosa-9p6dc.2eu0.p3.openshiftapps.com/oauth2callback/Cognito
+
